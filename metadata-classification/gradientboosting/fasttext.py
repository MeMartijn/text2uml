...
if __name__ == '__main__':
    ...
    for pooling_strategy in ['max', 'average', 'min']:
        ...
        report_dict = clfs.get_gradientboosting_scores(data, fasttext, pooling_strategy)
        pd.DataFrame(report_dict).to_csv(f'{pooling_strategy}_fasttext_gradientboosting.csv', index=False)
