...
if __name__ == '__main__':
    ...
    for pooling_strategy in ['max', 'average', 'min']:
        ...
        pooled_df = data.apply_pooling('max', transformerxl[['embedding', 'type']])
        ...
        pd.DataFrame(report_dict).to_csv(f'{pooling_strategy}_transformerxl_logres.csv', index=False)
